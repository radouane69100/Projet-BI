...
def etl_process(**kwargs):
    ...
    with mysql_connection.begin() as connection:
        connection.execute("DELETE FROM test.covid19_cases WHERE type = 'd'")
...
dag = DAG('covid19_dead_ingestion_dag', description='Dag to Ingest COVID19 deaths',
          default_args={
              'owner': 'b.a.',
...
etl = PythonOperator(task_id="covid19Dead_etl",
